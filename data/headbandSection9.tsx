...
export const headbandSection9Data: LanguageData = {
    zh: [
        {
            title: "采集管理",
            para: "统一管理任务进度、人员分配与设备状态，实时监控数据总量与完成率",
            pic: "https://assets.kinetixai.cn/shucai/s10-20260702-2/s9-1-1.jpg"
        },
        {
            title: "自动化质检",
            para: "可自动识别视频画质、关节姿态异常、数据同步异常等各类问题，生成质检报表，实时查看合格率与问题分布情况。",
            pic: "https://assets.kinetixai.cn/shucai/s10-20260702-2/s9-1-2.jpg"
        },
        {
            title: "语义标注 & 任务片段切分",
            para: "对视频逐帧标注，涵盖动作类型、交互物体、操作手等信息，并自动切分为独立任务片段，同时支持中英双语动作语义描述。",
            pic: "https://assets.kinetixai.cn/shucai/s10-20260702-2/s9-1-3.jpg"
        },
        {
            title: "数据增广",
            para: "对现有数据执行数据增强，生成补充训练样本，在扩充数据集规模的同时丰富视觉多样性。",
