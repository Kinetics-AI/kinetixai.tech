  ...
  return (
    <div className="w-full relative">
      ...
      >
            ...
            <CarouselItem key={index} className="pl-0 basis-full">
              <div className="w-full">
                ...
                <div className="mt-10 flex flex-row justify-center px-6">
                  <div className="max-w-6xl w-full flex flex-col lg:flex-row gap-10 justify-center chart-container">
                    {section.charts}
                  </div>
                </div>
                {/* Caption */}
                <div className="mt-5 flex justify-center px-6">
                  <p className="text-sm leading-relaxed text-muted-foreground/80 text-center max-w-3xl spara style-1">
                    {section.caption}
                  </p>
                </div>
              </div>
        ...
        <div className="absolute left-2 sm:left-4 lg:left-0 top-1/2 -translate-y-1/2 lg:-translate-x-12 z-20 prev-btn">
          <button
        ...
        <div className="absolute right-2 sm:right-4 lg:right-0 top-1/2 -translate-y-1/2 lg:translate-x-12 z-20 next-btn">
          <button
      ...
      <div className="flex justify-center items-center gap-2 mt-8 chart-dots">
